...
modeButton.addEventListener("click", () => {
    ...
    if (document.body.classList.contains("dark-mode")) {
        modeButton.src = "public/images/light-mode.svg";
        modeButton.alt = "Switch to light mode";
        modeButton.setAttribute("aria-label", "Activate light mode");

        const headerLogo = document.querySelector('header img');
        headerLogo.src = "public/images/logo-dark.webp";
        headerLogo.alt = "Logo in dark mode";
        headerLogo.width = 100;
        headerLogo.height = 84;

        document.querySelector('[aria-label="facebook"] img').src = "public/images/facebook-dark.svg";
        ...
        document.querySelector('[aria-label="instagram"] img').src = "public/images/instagram-dark.svg";
        ...
        document.querySelector('[aria-label="youtube"] img').src = "public/images/youtube-dark.svg";
        ...
        modeButton.src = "public/images/dark-mode.svg";
        modeButton.alt = "Switch to dark mode";
        modeButton.setAttribute("aria-label", "Activate dark mode");

        const headerLogo = document.querySelector('header img');
        headerLogo.src = "public/images/logo.webp";
        headerLogo.alt = "Logo";
        headerLogo.width = 300;
        headerLogo.height = 300;

        document.querySelector('[aria-label="facebook"] img').src = "public/images/facebook.svg";
        document.querySelector('[aria-label="facebook"] img').alt = "Facebook";
        document.querySelector('[aria-label="facebook"] img').width = 200;
        document.querySelector('[aria-label="facebook"] img').height = 200;

        document.querySelector('[aria-label="instagram"] img').src = "public/images/instagram.svg";
        document.querySelector('[aria-label="instagram"] img').alt = "Instagram";
        document.querySelector('[aria-label="instagram"] img').width = 200;
        document.querySelector('[aria-label="instagram"] img').height = 200;

        document.querySelector('[aria-label="youtube"] img').src = "public/images/youtube.svg";
